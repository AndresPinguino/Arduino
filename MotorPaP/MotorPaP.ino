...
Gira los grados que se le indiquen por el monitor serial
...
void loop() {
  ...
  if (leeCadena.length()>0){       
        ...
        delay(retardo);
        dato_rx = (dato_rx * 0.033333333); // Ajuste de (numero de pasos + 1) tengo una vuelta de 360 grados - (11+1)/360 = 0.033333333
  }  

   while (dato_rx>numero_pasos){   // Girohacia la derecha en grados
       paso_der();
