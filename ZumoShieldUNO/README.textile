...
Proyecto para usar las bibliotecas del kit robot Zumo Shield para Arduino UNO
conectando buzzer, motores y pulsadores, según se ve en el código *.cpp de las respectivas bibliotecas.
