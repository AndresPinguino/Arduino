...
// Modificar y adaptar para usar con Arduino Nano, sensores ultrasonicos, sensores CNY70 QTRC
// puente H y reemplazar LCD con un led RGB para ver los cambios de estado.
